...
var StartYear = 1740; //First Year in drop down year selection
var EndYear = 88; // The last year of pickable date. if current year is 2011, the last year that still picker will be 2016 (2011+5)
...
var MonthYearColor = "#399ee3"; //Font Color of Month and Year in Calendar header.
var WeekHeadColor = "#399ee3"; //var WeekHeadColor="#18861B";//Background Color in Week header.
var SundayColor = "#33CCFF"; //var SundayColor="#C0F64F";//Background color of Sunday.
var SaturdayColor = "#33CCFF"; //Background color of Saturday.
var WeekDayColor = "#519ee3"; //Background color of weekdays.
var FontColor = "blue"; //color of font in Calendar day cell.
var TodayColor = "#3366FF"; //var TodayColor="#FFFF33";//Background color of today.
var SelDateColor = "#FFFFFF"; //var SelDateColor = "#8DD53C";//Backgrond color of selected date in textbox.
